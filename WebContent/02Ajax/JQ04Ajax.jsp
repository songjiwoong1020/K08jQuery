...
/*
	$.ajax()
		...
		메소드의 특징 모두를 가지고 있다. 그러므로 가장 활용 빈도가 높다.
	...
	contentType : 전송 시 사용 할 컨텐츠 타입(get과 post가 다름)
	data : 서버로 전송 할 파라미터. JSON형식.
*/
$(function(){
	
	/*
	해당 메소드는 문서의 로드가 끝난 직 후 js파일의 내용을 읽어와서
...
/*
	요청 성공 시 호출할 콜백 메소드. 외부함수로 정의되어 있고
	함수명 만으로 호출 하더라도 콜백데이터는 파라미터로
	받을 수 있다.
*/		
